...
def parse_args():
    ...
    parser.add_argument('--Red_value', type=int, required=True)
    parser.add_argument('--Green_value', type=int, required=True)
    parser.add_argument('--Blue_value', type=int, required=True)
